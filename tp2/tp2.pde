...
void draw() {
  ...
  if (empujar && !mostrardiapo2) {
    ...
    fill(255); 
    textSize(32); 
    text("desarrollado y publicado \n por Bohemia Interactive.", 180, height / 2);
  ...
  if (mostrardiapo2) {
    ...
    textSize(25);
    textAlign(CENTER, CENTER);
    text("El juego dispone de \n una amplia comunidad activa \n y mods en el workshop, \n que mejoran la inmersion \n y jugabilidad de los usuarios.", width / 2, textoY);
  }
  ...
  text("Arma 3 es un videojuego de simulación militar,\n en mundo abierto", width / 2 + desplazamiento, height / 2);
